...
var DEFAULT_CDN = 'https://github.com/Ollebolle/phantomjs/releases/download/v2.5.0-beta'
...
function getDownloadSpec() {
  ...
  if (platform === 'linux' && arch === 'x64') {
    downloadUrl += 'linux-ubuntu-xenial-x86_64.tar.bz2'
    checksum = '7db6714339d424ecd145715a83f81d1e'
